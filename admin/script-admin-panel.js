    ...
    try {
        ...
        if (data) {
            ...
            articlesData = {
                ...
                '0003': { title: 'آموزش شبکه‌بندی', excerpt: 'آموزش تولید مش ساختار یافته', date: '۱۴۰۲/۱۲/۰۵', tags: ['آموزش', 'شبکه‌بندی'], type: 'tutorial' }
            };
            articlesSha = null;
        }
...
// ===== ویرایش کامل سفارش (نسخه کامل با دکمه ذخیره) =====
// ===== ویرایش کامل سفارش (نسخه کامل با دکمه ذخیره) =====
...
// ===== ۰۵۲۷ - حذف کامل کاربر =====
// ===== ۰۵۲۷ - حذف کامل کاربر (نسخه اصلاح‌شده) =====
...
// ============================================================
// ===== ۰۵۲۹ - رندر سفارشات (نسخه اصلاح‌شده - بدون بریس اضافی) =====
...
} // ✅ فقط یک بریس در انتها (بدون بریس اضافی)
