...
(function() {
    ...
    // ============================================================
    // 0009 - بارگذاری محصولات (Products)
    // ============================================================
    ...
    // ============================================================
    // توابع addTag, updateTagsHidden, generateArticleId, generateArticleContent
    // قبلاً در بخش‌های قبلی تعریف شده‌اند. در اینجا نسخه‌های جایگزین برای
    // استفاده با دکمه‌های onclick اضافه می‌شوند.

    // این توابع برای هماهنگی با دکمه‌های موجود در HTML نوشته شده‌اند
    // و قبلاً در بخش‌های ۰۵۱۳-۰۵۱۵ تعریف شده‌اند. اما برای اطمینان،
    ...
    // توابع saveArticle, saveProduct, saveArchive برای استفاده با دکمه‌های onclick
    // در بخش‌های ۰۰۱۶-۰۰۱۸ تعریف شده‌اند. اگر به‌درستی کار نمی‌کنند،
    // باید بررسی شوند که آیا توابع با نام‌های صحیح در دسترس هستند.
